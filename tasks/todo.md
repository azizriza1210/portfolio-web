...
- [ ] Task 0.1: Install Bun on Windows (`powershell -c "irm bun.sh/install.ps1|iex"`)
...
- [ ] Task 1.2: Verify Tailwind v4 (upgrade if v3)
...
- [ ] Task 2.2: Install next-themes + dark mode provider
...
- [ ] Task 3.2: Motion primitives (SpringDiv, gesture hooks, reduced-motion)
  ...
  - Files: src/components/motion/SpringDiv.tsx, src/components/motion/hooks.ts
...
- [ ] Task 5.2: Featured Projects section (3 RAG dummy)
...
- [ ] Task 5.3: Latest Posts section (3 previews)
